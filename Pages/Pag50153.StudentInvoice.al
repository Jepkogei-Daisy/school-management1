        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Session Code"; Rec."Session Code")
                {
                    ...
                    var
                        StudentInvoice: Record "Session Card";
                    begin
                        if Page.RunModal(Page::"Students in Session", StudentInvoice) = Action::LookupOK then
                            Rec."session code" := StudentInvoice."Session Code";
                        Rec."Course Name" := StudentInvoice."Course Name";
                        Rec."Academic Year" := StudentInvoice."Academic Year";
                        Rec."Semester Name" := StudentInvoice."Semester Name";
                        Rec."Application No." := StudentInvoice."Application No.";
                ...
                field("Application No."; Rec."Application No.")
                {
                    ...
                    // begin
                    //     if Page.RunModal(Page::"List of Registered Students", Invoice) = Action::LookupOK then
                    //         Rec."Application No." := Invoice."No.";
                    //     Rec."Student Name" := Invoice.Name;
                    //     Rec."Course Name" := Invoice."Course Name";
                    // end;
