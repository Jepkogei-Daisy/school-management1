codeunit 50139 "Finance Management"
{
    ...
    var
        ...
        Invoicelns2: Label 'Are you sure youwant to post %1';
    ...
    begin
        with Inv do begin
            ...
            if InvoiceLines.FindSet() then begin
                repeat
                    StudentFeeStructure.Get(InvoiceLines."Entry No.");

                    // edited for testing purpose(field from No to Name to entry No)
                    LineNo := LineNo + 1000;
